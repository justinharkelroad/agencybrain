-- Phase A: Add missing columns and fix flatten_quoted_household_details function

-- Add missing columns to quoted_household_details table
ALTER TABLE public.quoted_household_details 
ADD COLUMN IF NOT EXISTS agency_id uuid,
ADD COLUMN IF NOT EXISTS team_member_id uuid,
ADD COLUMN IF NOT EXISTS role app_member_role,
