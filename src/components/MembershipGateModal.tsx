...
import { Lock, Play, ArrowLeft, Sparkles, Crown } from "lucide-react";
...
interface MembershipGateModalProps {
  ...
  videoKey?: string;
  gateType?: 'one_on_one' | 'call_scoring_upsell';
  returnPath?: string;
}
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {isCallScoringUpsell ? featureName : '1:1 Coaching Feature'}
          </DialogTitle>
          <DialogDescription>
            {featureDescription || (
              isCallScoringUpsell 
