...
DECLARE
  ...
  v_payload_keys text[];
  v_current_detail jsonb;  -- NEW: Store current detail to preserve scope
BEGIN
  ...
  BEGIN
    ...
    LOOP
      ...
      BEGIN
        -- FIXED: Store current detail in local variable to preserve scope
        ...
        -- Extract custom field values (FIXED: use v_current_detail)
        ...
        -- Resolve lead source (FIXED: use v_current_detail)
        ...
        -- Insert record with preserved timestamp (FIXED: use v_current_detail)
