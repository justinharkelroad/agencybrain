-- ============================================================================
-- LQS Households → Metrics Daily Sync
-- 
...
WHERE table_name = 'lqs_households' 
  AND column_name = 'skip_metrics_increment';

-- Check 2: Trigger exists
SELECT tgname, tgenabled
FROM pg_trigger 
WHERE tgrelid = 'lqs_households'::regclass
  AND tgname = 'lqs_households_update_metrics';

-- Check 3: Functions exist
SELECT routine_name 
FROM information_schema.routines 
WHERE routine_schema = 'public' 
  AND routine_name IN ('increment_metrics_quoted_count', 'increment_quoted_count_from_lqs');
