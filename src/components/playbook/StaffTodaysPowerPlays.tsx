...
export function StaffTodaysPowerPlays() {
  const todayStr = format(new Date(), "yyyy-MM-dd");
  const weekKey = getWeekKey(new Date());
  const { items, isLoading, completeItem, uncompleteItem } = useStaffFocusItems(weekKey);
  const { weeklyPoints } = useStaffPlaybookStats();
