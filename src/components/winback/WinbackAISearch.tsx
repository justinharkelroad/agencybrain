...
import type { AIWinbackQueryResponse } from '@/types/winbackAIQuery';

interface WinbackAISearchProps {
  onClear: () => void;
  sendQuery: (query: string) => void;
  clearAIQuery: () => void;
  currentResult: AIWinbackQueryResponse | null;
  isLoading: boolean;
  isActive: boolean;
  turnCount: number;
}
...
const PLACEHOLDER_EXAMPLES = [
  'show me untouched accounts in 43210',
  'high premium opportunities teed up this week',
  'assigned to Sarah with multiple policies',
  'won back households sorted by premium',
];

export function WinbackAISearch({
  onClear,
  sendQuery,
  clearAIQuery,
  currentResult,
