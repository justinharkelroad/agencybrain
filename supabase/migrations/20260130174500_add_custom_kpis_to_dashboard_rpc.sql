-- Add custom_kpis to get_dashboard_daily RPC
-- This is needed for the ring display to show custom KPI values
...
RETURNS TABLE (
  ...
  custom_kpis jsonb,  -- ADDED: custom KPI values
  kpi_version_id uuid,
...
BEGIN
  ...
  WITH daily_data AS (
    SELECT
      ...
      COALESCE(md.custom_kpis, '{}'::jsonb) as custom_kpis,  -- ADDED
      md.kpi_version_id,
      md.label_at_submit
