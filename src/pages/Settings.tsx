      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Configure metrics, weights, and performance tracking
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure metrics, weights, and performance tracking for your team
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            {availableMetrics.length === 0 ? (
              ...
              <div className="space-y-6">
                {/* Role Selection - Inline Toggle Buttons */}
                <div>
                  <Label className="text-base font-medium">Configure rules for:</Label>
                  <div className="inline-flex rounded-md border mt-2">
                    <button
