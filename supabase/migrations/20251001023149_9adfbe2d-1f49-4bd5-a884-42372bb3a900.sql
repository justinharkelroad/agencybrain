-- Fix flatten_quoted_household_details_enhanced to preserve original submission timestamps
...
-- Delete all records created during the backfill with today's timestamp
DELETE FROM quoted_household_details 
WHERE created_at >= '2025-10-01 00:00:00+00' 
  AND created_at < '2025-10-02 00:00:00+00';