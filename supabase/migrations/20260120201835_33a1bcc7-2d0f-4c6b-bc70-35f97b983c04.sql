-- Fix get_staff_call_details RPC to allow managers to view any call in their agency
-- Previously: required team_member_id to match, breaking manager access to other team members' calls
-- Now: managers can pass NULL team_member_id + their agency_id to view any agency call
