...
-- Some environments may not have the sales table, so this migration is
-- intentionally idempotent and conditionally skips when absent.

DO $$
BEGIN
  IF to_regclass('public.sales') IS NULL THEN
    RAISE NOTICE 'Skipping % because public.sales does not exist.', '20260123141715_f958b968-e3a0-4dd5-8989-e40f403912bb';
    RETURN;
  END IF;
