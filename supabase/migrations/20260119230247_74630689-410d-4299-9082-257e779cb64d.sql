-- Drop and recreate get_contacts_by_stage with:
-- 1. No "unknown" stage - fallback to "open_lead"
-- 2. Add total_count to return
-- 3. Align stage logic with frontend determineLifecycleStage
    ...
    SELECT 
      ...
      COALESCE(
        (SELECT tm.name FROM winback_households wh 
         JOIN team_members tm ON wh.assigned_team_member_id = tm.id 
