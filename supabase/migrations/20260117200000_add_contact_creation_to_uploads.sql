-- Add contact creation to cancel audit upsert function
...
COMMENT ON FUNCTION upsert_cancel_audit_record IS 'Upserts cancel audit record and automatically creates/links unified contact';
