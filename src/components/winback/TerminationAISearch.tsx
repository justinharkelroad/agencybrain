...
import type { AITerminationQueryResponse } from '@/types/winbackAIQuery';

interface TerminationAISearchProps {
  onClear: () => void;
  sendQuery: (query: string) => void;
  clearAIQuery: () => void;
  currentResult: AITerminationQueryResponse | null;
  isLoading: boolean;
  isActive: boolean;
  turnCount: number;
}
...
const PLACEHOLDER_EXAMPLES = [
  'show me auto policy losses this month',
  'high premium terminations by reason',
  'producer John items lost leaderboard',
  'hide cancel rewrites sort by premium',
];

export function TerminationAISearch({
  onClear,
  sendQuery,
  clearAIQuery,
  currentResult,
