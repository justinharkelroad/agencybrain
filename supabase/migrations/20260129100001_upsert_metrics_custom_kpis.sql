-- Fix metrics key mismatch: read both old keys (quoted_count, sold_items)
-- AND new keys (quoted_households, items_sold) from form payloads
-- ADDED: Extract custom KPIs and store in custom_kpis JSONB column
