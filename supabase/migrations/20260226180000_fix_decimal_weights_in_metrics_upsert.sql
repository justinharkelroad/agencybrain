-- Fix "invalid input syntax for type integer: 33.33" crash in upsert_metrics_from_submission.
-- scorecard_rules.weights JSONB can contain decimal values (e.g. 33.33).
-- Cast through ::numeric first before ::int to handle decimals safely.
-- Same fix was applied to recalculate_metrics_hits_pass in 20260226160000.
...
BEGIN
  ...
  -- ============================================
  -- Extract KPI values from form schema for ALL KPI types
  -- ============================================
  BEGIN
  ...
  -- Use ::numeric::int to safely handle decimal weight values (e.g. 33.33)
  ...
  -- Use n_required per supabase/CLAUDE.md Rule 5
