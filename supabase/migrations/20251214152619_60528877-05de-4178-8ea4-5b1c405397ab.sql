-- RPC function for staff users to fetch full call details
...
GRANT EXECUTE ON FUNCTION get_staff_call_details(UUID, UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION get_staff_call_details(UUID, UUID) TO anon;