-- Migration: Fix winback_activities constraint and improve multi-word search
-- Date: 2026-01-19
-- Issues Fixed:
-- 1. Won Back button fails due to missing 'won_back' in activity_type constraint
-- 2. Multi-word search doesn't work (searches for entire string instead of individual words)
