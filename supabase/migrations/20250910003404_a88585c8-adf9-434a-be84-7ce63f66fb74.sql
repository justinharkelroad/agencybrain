-- Create test version without RLS for performance analysis
CREATE OR REPLACE FUNCTION public.get_versioned_dashboard_data_test(
  p_agency_slug text,
  p_role text,
...
BEGIN
  ...
  -- Skip RLS check for performance testing
