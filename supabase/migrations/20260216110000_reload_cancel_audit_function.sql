-- Force PostgREST schema cache reload after dropping old overloads.
-- Re-create the function to trigger DDL event + explicit NOTIFY.
...
-- Recreate the correct 21-param version
