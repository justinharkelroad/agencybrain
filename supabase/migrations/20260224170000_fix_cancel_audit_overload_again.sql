-- Fix: PostgREST can't resolve overloaded upsert_cancel_audit_record (again)
-- Migration 20260220200000 added enrichment params via CREATE OR REPLACE,
-- but because the param list differed (26 vs 21), PostgreSQL created a new
-- overload instead of replacing. PostgREST can't pick between the two,
-- causing ALL cancel audit uploads to fail (169/169 errors).
--
-- Fix: Drop ALL old overloads, then recreate the single 26-param version.

-- Drop the 21-param version (from 20260220100000)
DROP FUNCTION IF EXISTS upsert_cancel_audit_record(
  UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT,
  BIGINT, INTEGER, TEXT, TEXT, BIGINT, DATE, DATE, DATE, UUID, TEXT, TEXT
);

-- Drop any other stale overloads that might linger
DROP FUNCTION IF EXISTS upsert_cancel_audit_record(
  UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT,
...
-- Drop the 26-param version too so we can recreate cleanly
DROP FUNCTION IF EXISTS upsert_cancel_audit_record(
  UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT,
  BIGINT, INTEGER, TEXT, TEXT, BIGINT, DATE, DATE, DATE, UUID, TEXT, TEXT,
...
-- Recreate the single correct 26-param version with enrichment columns
