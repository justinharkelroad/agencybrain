-- Fix winback_households join in get_contacts_by_stage (winback_households has no household_key)
...
BEGIN
  WITH filtered_contacts AS (
    ...
    LEFT JOIN winback_households wh ON wh.agency_id = ac.agency_id AND wh.contact_id = ac.id
